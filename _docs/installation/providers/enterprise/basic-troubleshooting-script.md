...
- To download the script, **[Click here](/scripts/troubleshooting-scripts/basic-troubleshoot.sh)** or run the *wget* command below.
```sh
wget http://raw.githubusercontent.com/faveosuite/faveo-server-images/refs/heads/master/scripts/troubleshooting-scripts/basic-troubleshoot.sh
```
