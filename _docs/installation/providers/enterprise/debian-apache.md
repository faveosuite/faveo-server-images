...
After installing PHP 8.4, run the commands below to open PHP default config file.
```sh
...
sed -i '2 a zend_extension = "/usr/lib/php/'replaceyourpath'/ioncube_loader_lin_8.4.so"' /etc/php/8.4/apache2/php.ini
